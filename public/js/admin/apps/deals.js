var TableDatatablesManaged = function () {
    ...
    var initTable = function () {
        ...
        //type on change
        $('#modal_model_update [name="type"]').on('change', function () {
            if($(this).val() == 'url')
            {
                $('#subform_url').css('display','block');
                $('#subform_show_coupon').css('display','none');
            }
            else
            {
                $('#subform_url').css('display','none');
                $('#subform_show_coupon').css('display','block');
            }
        });
        //function add
        ...
        $('#btn_model_edit').on('click', function(ev) {
            ...
            jQuery.ajax({
                ...
                error: function(){
                    swal({
                        title: "<span style='color:red;'>Error!</span>",
                        text: "There was an error trying to get the deal's information!<br>The request could not be sent to the server.",
                        html: true,
                        type: "error"
                    });
                }
            ...
            if($('#form_model_update').valid())
            {
                ...
                jQuery.ajax({
                    ...
                    error: function(){
                        swal({
                            title: "<span style='color:red;'>Error!</span>",
                            text: "There was an error trying to save the deal's information!<br>The request could not be sent to the server.",
                            html: true,
                            type: "error"
                        },function(){
                            $('#modal_model_update').modal('show');
        ...
        $('#btn_model_remove').on('click', function(ev) {
            ...
            swal({
                title: "The following deals(s) will be removed, please confirm action: ",
                ...
                if (isConfirm) {
                    ...
                    jQuery.ajax({
                        ...
                        error: function(){
                            swal({
                                title: "<span style='color:red;'>Error!</span>",
                                text: "There was an error deleting the deal(s)!<br>They might have some dependences<br>or<br>the request could not be sent to the server.",
                                html: true,
                                type: "error"
                            });
                        }
        ...
        $('#btn_deals_upload_image_url').on('click', function(ev) {
            FormImageUpload('deals.image_url','#modal_model_update','#form_model_update [name="image_url"]');       
        });        
        //init functions
        check_models();   
        $("#form_model_update [name='type']").val('url').trigger('change');
