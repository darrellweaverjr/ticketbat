    ...
    var update_items = function (items) {
        ...
        $.each(items,function(k, v) {
            ...
            if(v.image_id)
                ...
                v.image_id = '-No image-';
            $('#tb_restaurant_items').append('<tr data-id="'+v.id+'"><td>'+v.menu+'</td><td>'+v.order+'</td><td>'+v.name+'</td><td>$'+v.price+'</td><td>'+v.enabled+'</td><td>'+v.image_id+'</td>'+row_edit+'</tr>');
        });   
    }
...
var FormItemsValidation = function () {
    return {
        ...
        init: function () {
            ...
            MainFormValidation.init('form_model_restaurant_items',rules,{});
        }
    };
}();
//*****************************************************************************************
