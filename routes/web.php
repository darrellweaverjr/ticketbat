...
Route::group(['prefix' => 'admin','middleware' => 'auth','namespace' => 'Admin'], function () {
    ...
    //restaurants
    Route::match(['get','post'], 'restaurants/reservations', 'RestaurantController@reservations')->middleware('permissions:RESTAURANTS');
    ...
    Route::match(['get','post'], 'restaurants/awards', 'RestaurantController@awards')->middleware('permissions:RESTAURANTS');
    Route::match(['get','post'], 'restaurants/reviews', 'RestaurantController@reviews')->middleware('permissions:RESTAURANTS');
    Route::match(['get','post'], 'restaurants/comments', 'RestaurantController@comments')->middleware('permissions:RESTAURANTS');
    Route::match(['get','post'], 'restaurants/albums', 'RestaurantController@albums')->middleware('permissions:RESTAURANTS');
