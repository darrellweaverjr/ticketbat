            ...
            <div class="modal-body" >
                <div data-always-visible="1" data-rail-visible1="1">
                    <div class="row" style="padding:20px">
                        <div class="col-lg-6"><center><img height="192" src="https://www.cvvnumber.com/csc_1.gif" width="351" align="left" border="0" alt="cvv"></center></div>
                        <div class="col-lg-6">
                    ...
                    <div class="row" style="padding:20px">
                        ...
                        <div class="col-lg-4"><center><img height="140" src="https://www.cvvnumber.com/csc_2.gif" width="200" align="right" border="0" alt="cid"></center></div>
                    </div>
                </div>
            </div>
