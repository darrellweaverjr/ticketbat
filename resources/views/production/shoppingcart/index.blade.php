                ...
                <div class="portlet light bordered">
                    <div class="portlet-body">
                        ...
                        <div class="tab-content" id="tabs_payment">
                            ...
                            <div class="tab-pane fade active in @if(!($cart['total']>0) || $cart['seller']<1) hidden @endif" id="tab_cash">
                                <div class="row">
                                    <!-- BEGIN FORM-->
                            ...
                            <div class="tab-pane fade  in @if(!($cart['total']>0)) hidden @endif" id="tab_card">
                                <div class="row">
