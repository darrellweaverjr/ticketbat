                            ...
                            @foreach($categories as $index=>$c)
                                @if($c->id_parent == 0)
                                    <tr>
                                        ...
                                        <td width="10%"><input type="checkbox" class="make-switch" name="active" value="{{$c->id}}" @if(!$c->disabled) checked @endif data-size="mini" data-on-text="Enabled" data-off-text="Disabled" data-on-color="primary" data-off-color="danger"></td>
                                    </tr>
                                    @foreach ($c->children()->get() as $children)
                                        <tr>
                                            ...
                                            <td width="10%"><input type="checkbox" class="make-switch" name="active" value="{{$children->id}}" @if(!$children->disabled) checked @endif data-size="mini" data-on-text="Enabled" data-off-text="Disabled" data-on-color="primary" data-off-color="danger"></td>
                                        </tr>
                                        @foreach ($children->children()->get() as $niece)
                                            <tr>
                                                ...
                                                <td width="10%"><input type="checkbox" class="make-switch" name="active" value="{{$niece->id}}" @if(!$niece->disabled) checked @endif data-size="mini" data-on-text="Enabled" data-off-text="Disabled" data-on-color="primary" data-off-color="danger"></td>
                                            </tr>
                                        @endforeach
                                    @endforeach
                                @endif
