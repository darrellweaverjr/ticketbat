                    ...
                    <table class="table table-striped table-bordered table-hover" id="tb_model">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">@if(Auth::user()->user_type_id != 5) Comm. @else TB Comm.<br>Expen. @endif</th>
                                <th style="text-align:center">P.Fees</th>
                                <th style="text-align:center">@if(Auth::user()->user_type_id != 5) Gross<br>Profit @else TB<br>Retains @endif</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($data as $d)
