        ...
        <div class="col-md-12">
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" id="tb_model_permissions">
                        <thead>
                            <tr>
                                <th width="2%">
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" class="group-checkable" data-set="#tb_model_permissions .checkboxes" />
                                        <span></span>
                                    </label>
                                </th>
