...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo e(url('/login')); ?>" method="post"><?php echo e(csrf_field()); ?>
                ...
                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="username" value="<?php echo e(old('email')); ?>" required autofocus /> 
        ...
        <div class="copyright"> <?php echo e(date('Y')); ?> © TicketBat.com </div>
        <!--[if lt IE 9]>
