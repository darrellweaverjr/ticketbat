...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo e(url('/login')); ?>" method="post"><?php echo e(csrf_field()); ?>

                <h3 class="form-title font-green"><?php echo e(config('app.name', 'Laravel')); ?></h3>
                ...
                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" required autofocus /> 
        ...
        <div class="copyright"> <?php echo e(date('Y')); ?> © TicketBat. </div>
        <!--[if lt IE 9]>
