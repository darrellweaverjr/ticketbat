            ...
            <a class="dashboard-stat dashboard-stat-v2 dark">
                ...
                <div class="details">
                    ...
                    <div class="desc">Tickets Sold 
                        <br>Purchases: <span data-counter="counterup" data-value="<?php echo e(number_format(count($data))); ?>">0</span>
                    </div>
                </div>
            </a>
        </div>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="tb_model">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Show: <a><?php echo e($d->show_name); ?></a>,<br> Customer: <a><?php echo e($d->name); ?></a>,<br> Order#: <a><?php echo e($d->id); ?></a>, Code: <a><?php echo e($d->code); ?></a>, Ticket Type: <a><?php echo e($d->ticket_type); ?></a></td>
                                ...
                                <td style="text-align:center" data-order="<?php echo e(strtotime($d->created)); ?>"><?php echo e(date('m/d/Y g:ia',strtotime($d->created))); ?></td>
