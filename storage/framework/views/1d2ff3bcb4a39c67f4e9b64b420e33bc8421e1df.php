...
<?php $__env->startSection('content'); ?> 
    ...
    <div class="row">
       <div style="display:none" id="referral_json"><?php echo e($graph); ?></div>
       <div class="col-md-6">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="tb_model">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <?php if($order=='url'): ?>
                                <td><?php echo e($d->referral_url); ?></td>
                                    ...
                                    <div class="col-md-9 show-error">
                                        <div class="input-group">
                                            <select class="form-control" name="order" style="width: 321px !important">
                                                ...
                                                <option <?php if($order=='show'): ?> selected <?php endif; ?> value="show">Show</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>   
