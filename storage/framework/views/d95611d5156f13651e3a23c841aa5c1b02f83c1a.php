    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-wrapper">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile"> Hello, <?php echo e(Auth::user()->first_name); ?> </span>
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item start open <?php if(!(strpos(url()->current(),'/admin/home')===false) || !(strpos(url()->current(),'/admin/dashboard')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('USERS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/users')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('BANDS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/bands')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('VENUES', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/venues')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('SHOWS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/shows')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('TYPES', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/ticket_types')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('COUPONS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/coupons')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('PACKAGES', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/packages')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('ACLS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/acls')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('MANIFESTS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/manifests')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('CONTACTS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/contacts')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('PURCHASES', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/purchases')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('SLIDERS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/sliders')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('TICKETS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/consignments')===false)): ?> active <?php endif; ?>">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type->id == 1 || array_key_exists('APPS', Auth::user()->user_type->getACLs()['acl_codes'])): ?>
                            <li class="nav-item <?php if(!(strpos(url()->current(),'/admin/apps')===false)): ?> active <?php endif; ?>">
                                ...
                                <div class="modal-dialog" style="width:800px !important;">
                                    <div class="modal-content portlet">
                                        <div class="modal-header alert-block bg-dark">
                                            <h4 class="modal-title bold uppercase" style="color:white;"><center><?php echo e(Auth::user()->first_name); ?>'s Profile</center></h4>
                                        </div>
                                        <div class="modal-body">
                                            <!-- BEGIN FORM-->
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="first_name" value="<?php echo e(Auth::user()->first_name); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div>   
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="last_name" value="<?php echo e(Auth::user()->last_name); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div>   
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="email" value="<?php echo e(Auth::user()->email); ?>" readonly="true" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="phone" value="<?php echo e(Auth::user()->phone); ?>" required="false"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="address" value="<?php echo e(Auth::user()->location->address); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div>   
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="city" value="<?php echo e(Auth::user()->location->city); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div>   
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="state" value="<?php echo e(Auth::user()->location->state); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="zip" value="<?php echo e(Auth::user()->location->zip); ?>" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 show-error">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="country" value="<?php echo e(Auth::user()->location->country); ?>" readonly="true" required="true"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                        </div>
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> <?php echo e(date('Y')); ?> &copy; <?php echo e(config('app.name', 'TicketBat Admin')); ?> By
